...
class Multiscale_SS2D(nn.Module):
    def __init__(
        self,
        # basic dims ===========
        d_model=96,
    ...
    def forwardv2(self, input: list, **kwargs):
        output=[]
        for x in input:
...
class Multiscale_VSSBlock(nn.Module):
    def __init__(
        self,
        hidden_dim: int = 0,
        drop_path: float = 0,
